...
class Rp1Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pidsus.dik.process.rp1.rp1_list', ['cases' => $cases]);
    }
    ...
    {
        return view('pidsus.dik.process.rp1.rp1_create');
    }
    ...
    public function edit($id)
    {
        ...
        if ($case && !empty($case)) {
            return view('pidsus.dik.process.rp1.rp1_edit')->with(compact('case'));
        } else {
            return redirect()->route('rp1.index');
        }
    }
