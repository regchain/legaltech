...
<div class="box">
  ...
  <div class="box-body">
    <div class="col-sm-12">
      @include('elapdu.lapdu.partials._disposisi_row2')
    </div>
  </div>
  <div class="box-body">
    <div class="col-sm-12">
      @include('elapdu.lapdu.partials._disposisi_kejati')
    </div>
  </div>
  
  <div class="box-body">
    <div class="col-sm-12">
      @include('elapdu.lapdu.partials._lanjutan_inspektur')
    </div>
    <div class="col-sm-12">
      @include('elapdu.lapdu.partials._lanjutan_kejati')
    </div>
  </div>
</div>
...
<div class="box">
  ...
  <div class="box-footer">
    ...
    <div class="row no-print">
      <div class="col-xs-12">
        <a href='laporan' class="btn btn-success pull-right" style="margin-right: 5px;"><i class="fa fa-check-square-o"></i> Lanjut
        </a>
