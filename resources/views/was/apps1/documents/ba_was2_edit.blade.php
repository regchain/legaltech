...
@section('judulhalaman', 'KARTU KLARIFIKASI')
...
<div class="box">
  ...
  <div class="box-body">
    @include('elapdu.surat.partials._ba_was2_edit')
       ...
       <form>
         <textarea id="kesimpulan" name="kesimpulan" rows="10" cols="80">
         </textarea>
       </form>
       </div>
     </div>
   <div class="box-footer">
    ...
    <div class="row no-print">
      <div class="col-xs-12">
        <a href='klarifikasi_proses' class="btn btn-info pull-right" data-toggle="tooltip" data-placement="top" title="Isi Kesimpulan atas klarifikasi subyek hukum terkait" style="margin-right: 5px;"><i class="fa fa-save"></i> Simpan
        </a>
