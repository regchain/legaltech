  ...
  <div class="box-body">
   ...
   <div class="box-footer">
    ...
    <div class="row no-print">
      <div class="col-xs-12">
        <a href='inspeksi_disposisi' class="btn btn-info pull-right" data-toggle="tooltip" data-placement="top" title="Isi Kesimpulan atas wawancara subyek hukum terkait" style="margin-right: 5px;"><i class="fa fa-save"></i> Simpan
        </a>
