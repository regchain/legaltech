...
@section('judulhalaman', 'Surat Perintah Inspeksi Kasus')
...
<div class="box">
 ...
 <div class="box-header with-border">
  <small class="col-xs-3 pull-right text-justify">Lampiran Petunjuk Pelaksanaan JAMWAS Nomor ; 01/H/Hjw/04//2011 tanggal 01 April 2011 tentang Teknis Penanganan Laporan dan Tata Kelola Administrasi Bidang Pengawasan<br><strong class="pull-right">SP.WAS-2</strong></small>
...
<div class="box-body">
  <div class="col-sm-3">
   <div class="input-group">
    ...
    <input type="text" class="form-control" placeholder="[no_sp.was2]">
  </div>
</div>
...
<div class="box-body">
  @include('was.elapdu.documents.partials._sp_was2_create')
</div>
