...
<div class="description-block">
     <h4 class="widget-user-name">SURAT PERINTAH [JAKSA AGUNG]</h4>
 ...
 <div class="col-sm-6 text-right">
    <p>NOMOR : PRIN-XXXXX XXXXXX</p>
</div>
<div class="col-sm-6">
 <p>Tanggal : [dd] [mmm] [yyyy] </p>
<!-- /.form group --></div>
        ...
        <table id="example2" class="table table-bordered table-striped">
          <tbody>
            <tr>
              ...
              <td>: [Nama Lengkap]</td>
              <td width="10%"><a href="#" class="btn btn-flat btn-xs btn-default"><i class="fa fa-remove"></i></a></td>
            </tr>
            <tr>
              <td></td>
            ...
            <tr>
              ...
              <td>: [123456] | [12344556788] </td>
              <td></td>
              <tr>
                <td></td>
                <td><strong>Jabatan</strong></td>
                <td>: [Jabatan], [Satuan Kerja] </td>
                <td></td>
              </tr>
            </tbody>
          </table>
