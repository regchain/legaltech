...
<div class="box">
  ...
  <div class="box-footer">
    ...
    <div class="row no-print">
        <a href='#' class="btn btn-info"><i class="fa fa-save"></i> Simpan</a>
        <a href='laporan_disposisi' class="btn btn-success pull-right" Tidak perlu ditindakJanjuti;><i class="fa fa-check-square-o"></i> Lanjut
        </a>
