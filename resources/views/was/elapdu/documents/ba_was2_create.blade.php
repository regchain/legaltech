...
<div class="box">
  ...
  <div class="box-header with-border">
    <small class="col-xs-3 pull-right text-justify">Lampiran Petunjuk Pelaksanaan JAMWAS Nomor; 01/H/Hjw/04//2011 tanggal 01 April 2011 tentang Teknis Penanganan Laporan dan Tata Kelola Administrasi Bidang Pengawasan<br><strong class="pull-right">BA.WAS-2</strong></small>
  ...
  <div class="box-body">
   ...
   <div class="box-footer">
    ...
    <div class="row no-print">
      <div class="col-xs-12">
        <a href='klarifikasi_proses' class="btn btn-success pull-right"style="margin-right: 5px;"><i class="fa fa-check-square-o"></i> Lanjut
        </a>
