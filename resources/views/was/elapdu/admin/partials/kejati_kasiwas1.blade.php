<div class="col-sm-12">
    ...
    <div class="description-block">
      <div class="form-group">
        ...
        <select class="form-control select2" style="width: 100%;" id="kasiwas">
          <option selected="selected">KasiWAS PEGASUM & KEPBANG</option>
          ...
          <div class="description-block">
            <div class="form-group">
              <select class="form-control select2" style="width: 100%;" id="kasiwas">
                ...
                <option>RIKSA PEGASUM</option>
                <option>RIKSA KEPBANG</option>
              </select>
            </div>
          </div>
          <!-- /.description-block -->
