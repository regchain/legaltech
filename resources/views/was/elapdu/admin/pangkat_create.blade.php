...
@section('content')
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Tambah Pangkat Baru</h3>
        ...
        <div class="box-body">
            <div class="col-xs-12">
              <div class="input-group">
                ...
                <input class="form-control" placeholder="Golongan...." type="text">
              </div>
            </div>
          </div>
        <!-- /.box-body -->
        ...
        <div class="box-body">
            <div class="col-xs-12">
              <div class="input-group">
                ...
                <input class="form-control" placeholder="Pangkat...." type="text">
              </div>
            </div>
          </div>
        <!-- /.box-body -->
