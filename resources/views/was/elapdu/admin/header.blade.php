<!-- Main Header -->
  <header class="main-header">
    ...
    <a href="{{ url('/administrator') }}" class="logo">
      ...
      <span class="logo-lg"><img src="{{asset('bower_components/admin-lte/dist/img/logo-kejaksaan-dark.png')}}" height="50"></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-body text-center"><small>[Jabatan] + [Satuan Kerja] </small></li>
              <!-- Menu Body -->
              <li class="user-body">
                {{-- <div class="row">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="pengguna" class="btn btn-default btn-flat">Data Pribadi</a>
                </div>
