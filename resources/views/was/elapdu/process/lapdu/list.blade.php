...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="nav-tabs-custom">
      <a href="laporan_create" class="btn btn-primary btn-Ssm pull-right"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; LAPORAN PENGADUAN
      </a>
      <ul class="nav nav-tabs">
        <li class="active"><a href="#tab_1" data-toggle="tab"><span class="badge bg-yellow pull-right">10</span> LAPORAN BARU&nbsp;</a></li>
