...
<div class="box-body">
 ...
 @include('was.elapdu.process.usulan.partials._disposisi_row2')

 @include('was.elapdu.process.usulan.partials._disposisi_kejati')
...
<div class="box-body">
 ...
 @include('was.elapdu.process.usulan.partials._lanjutan_inspektur')

  @include('was.elapdu.process.usulan.partials._lanjutan_kejati')
...
<div class="box">
<div class="box-header with-border">
  <h3 class="box-title">RENCANA PENJATUHAN HUKUMAN DISIPLIN</h3><br>
</div>
<div class="box-body">
  @include('was.elapdu.process.usulan.partials._usulan_view')
</div>
   ...
   <div class="box-footer">
    ...
    <div class="row no-print">
      <div class="col-xs-12">
        <a href='usulan' class="btn btn-success pull-right" style="margin-right: 5px;"><i class="fa fa-check-square-o"></i> Lanjut
        </a>
