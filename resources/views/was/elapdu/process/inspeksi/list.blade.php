...
@section('judulhalaman', 'Tahap Inspeksi Kasus')
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
          <div class="box-header">
            <h3 class="box-title">INSPEKSI KASUS BARU</h3>
            <div class="box-tools">
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group-vertical pull-right" role="group" aria-label="...">
                      <a href="inspeksi_view" class="btn btn-default"><i class="fa fa-eye"></i> Lihat Detil</a>
                      <a href="#" class="btn btn-default"><i class="fa fa-edit"></i> Edit</a>
                      <a href="inspeksi_disposisi" class="btn btn-default"><i class="fa fa-mail-forward"></i> Tindak Lanjut</a>
                    </div>
                  </td>
                </tr>
                <tr>
        ...
        <div class="tab-pane" id="tab_2">
          <div class="box-header">
            <h3 class="box-title">TAHAP INSPEKSI KASUS LANJUTAN</h3>
