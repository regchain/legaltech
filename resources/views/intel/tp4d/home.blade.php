      ...
      <div class="col-md-4">
        <div class="box box-default">
          <div class="box-header with-border">
            ...
            <h3 class="box-title">e-Budgeting</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
      ...
      <div class="col-md-4">
        <div class="box box-default">
          <div class="box-header with-border">
            ...
            <h3 class="box-title">e-Project Planning</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="alert alert-danger alert-dismissible">
    ...
    <h4><small class="pull-right"> source: e-BERKAS©</small><i class="fa fa-balance-scale"> </i> PENGADAAN</h4>    
      ...
      <div class="col-md-6">
        <div class="box box-default">
          <div class="box-header with-border">
            <i class="fa fa-angle-right"></i>
            <h3 class="box-title">e-Procurement [LPSE]</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="alert alert-warning alert-dismissible">
      ...
      <div class="col-md-6">
        <div class="box box-default">
          <div class="box-header with-border">
            ...
            <h3 class="box-title">e-Swakelola</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="alert alert-info alert-dismissible">
      ...
      <!-- /.col -->
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            ...
            <h3 class="box-title">e-Kontrak</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="alert alert-danger alert-dismissible">
      ...
      <div class="col-md-4">
        <div class="box box-default">
          <div class="box-header with-border">
            ...
            <h3 class="box-title">e-Progress</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="alert alert-danger alert-dismissible">
      ...
      <div class="col-md-4">
        <div class="box box-default">
          <div class="box-header with-border">
            ...
            <h3 class="box-title">e-Performance</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="alert alert-danger alert-dismissible">
